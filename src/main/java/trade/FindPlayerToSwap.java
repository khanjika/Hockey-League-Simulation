...
//
//    @Override
//    public LeagueModel findPlayersToSwap(ILeagueModel league, ITeamsModel team, ITradeTeamPojo tradingTeamDetails) {
//        IUserTradeCli userTrade = new UserTradeCli();
//        IGamePlayConfigModel gameConfig = league.getGameplayConfig();
...
//
//    @Override
//    public ITradeModel offeredPlayer(ITeamsModel team, ITradingModel tradeModel) {
...
//    }
//
//    public ITradeModel findTeamForSwap(ILeagueModel league, ITradeTeamPojo tradingTeamDetails, ITradeModel trade) {
...
//    }
//
//    public List<PlayerModel> playersFromTeam(ITeamsModel team, ITradeModel trade) {
